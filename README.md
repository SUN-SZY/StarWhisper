...
5.根据《Virtual-GOTTA：基于人工智能的虚拟司天工程》报告，星语5.0+将面向科学级望远镜的具身智能化改造：以星语大模型为智能体入口，打通警报发布、台站信息、望远镜状态与实时响应链路，服务全球暂现源望远镜数据组网系统，并支撑超新星时钟等小于1天爆发的极早期候选警报。交互式路线图见 [Virtual-GOTTA Map](docs/virtual-gotta-map.html)。
